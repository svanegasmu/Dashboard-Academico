...
function agregarBloqueHorario(
    ...
    if (
        ...
        throw new Error(
            "El nuevo bloque se superpone con otro bloque del mismo día."
        );
...
/* =========================================================
   OBTENER FECHA DE LA PRÓXIMA OCURRENCIA
========================================================= */

function obtenerProximaFechaDia(
    dia,
    desdeFecha = new Date()
) {
